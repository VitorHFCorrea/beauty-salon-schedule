  ...
  return (
    <DayPicker
      ...
      classNames={{
        ...
        caption_label: cn(
          "select-none font-medium first-letter:uppercase",
          captionLayout === "label"
            ? "text-sm"
        ...
        weekday: cn(
          "text-muted-foreground flex-1 select-none rounded-md text-[0.8rem] font-normal first-letter:uppercase",
